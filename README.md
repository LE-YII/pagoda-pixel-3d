...
### 实拍截图（页面实际导出的 PNG，下方直接显示原图）

**实体外观（像素粒度 3×）**
![实体外观（像素粒度 3×）](screenshots/木塔像素剖视_1787234248449.png)

**半剖透视（剖切面斜切）**
![半剖透视（剖切面斜切）](screenshots/木塔像素剖视_1787234333511.png)

**X 光透视（外壳半透明）**
![X 光透视（外壳半透明）](screenshots/木塔像素剖视_1787234372809.png)

**层展爆炸视图**
![层展爆炸视图](screenshots/木塔像素剖视_1787234414954.png)

**全屏外观抓图（另存）**
![全屏外观抓图（另存）](screenshots/50687c15-6198-4ac7-adc7-6c5bbe8845f7.png)

**全屏透视抓图（另存）**
![全屏透视抓图（另存）](screenshots/a40815a6-3f44-4b1e-a5e1-099860b5b84f.png)
